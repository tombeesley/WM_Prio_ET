...
n_trial = 44 * 5 # Default N test trials 
n_prac_trial_pri = 5
...
# Creating the window
mywin = visual.Window(size=[1440, 900], monitor = "testMonitor", fullscr=True, allowGUI=False, color="grey", units = 'deg')
...
def present_trial(trial, test_stage):
    ...
    save_data(trial, test_stage, response)
